...
('quem sao vcs', ARRAY['quem', 'sao', 'vcs'], '🚀 A Viraweb é uma empresa de tecnologia especializada em criação de sites, tráfego pago e soluções digitais.\n\n💻 Também somos criadores do **GDC – Gestor de Clientes**, um SaaS completo para gerenciar leads, clientes e vendas.\n\n🌐 Saiba mais em: https://viraweb.online', 'institucional'),
('q empresa eh essa', ARRAY['que', 'empresa', 'essa'], '🚀 A Viraweb é uma empresa de tecnologia especializada em criação de sites, tráfego pago e soluções digitais.\n\n💻 Também somos criadores do **GDC – Gestor de Clientes**, um SaaS completo para gerenciar leads, clientes e vendas.\n\n🌐 Saiba mais em: https://viraweb.online', 'institucional'),
...
('Vocês tem sistema de gestão?', 
 ARRAY['sistema', 'gestao', 'crm', 'software', 'admin'], 
 '📊 O **GDC – Gestor de Clientes** é um sistema SaaS da Viraweb para organizar, gerenciar seus clientes, agendamentos, profissionais, financeiro e muito mais.\n\n 🌐 Acesse: https://gdc.viraweb.online', 
 'institucional'),
